...
/*--------------------------------------------
* getEventState(Event *event)
*---------------------------------------------
*/
bool HyPerf_getEventState(VMEvent *event)
{
	printf("HyPerf_getEventState: HEY I am Test and have been summond------------------------------> \n");
	return true;
}
...
main(int argc, char **argv)
{
	...
	KVMInterface kvmInfo = {
		.getEventState = HyPerf_getEventState,
	};
